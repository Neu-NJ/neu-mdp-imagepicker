...
- (void)viewDidLoad
{
    ...
    self.navigationController.navigationBar.barTintColor = [UIColor colorWithRed:(94/255.0) green:(127/255.0) blue:(255/255.0) alpha:1];
...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            [self.navigationItem setTitle:self.singleSelection ? @"所有照片" : @"所有照片"];
...
{
	return self.view.frame.size.width /4 +1;
}
